...
//         ).isInstanceOf(ArithmeticException.class);
        ...
        System.out.println("Введите ожидаемый результат: ");
        double expected  = scanner.nextDouble();

//        double discountInvoice = calculatingDiscount(-10, 20);
        double discountInvoice = calculatingDiscount(purchaseAmount, discountAmount);
        System.out.println("Со скидкой " + discountInvoice);
        assertThat(discountInvoice).isEqualTo(expected);
